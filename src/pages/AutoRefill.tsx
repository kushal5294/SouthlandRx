...
export const AutoRefill = () => {
  return (
    <>
      <Helmet>
        <title>Auto Refills - Southland Pharmacy</title>
        <meta
          name="description"
          content="Set up automatic prescription refills at Southland Pharmacy in Taylor, Michigan. Save time and avoid multiple trips to the pharmacy with our convenient auto-refill service."
        />
      </Helmet>
