...
export const Transfer = () => {
  return (
    <>
      <Helmet>
        <title>Transfer Prescription - Southland Pharmacy</title>
        <meta
          name="description"
          content="Easily transfer your prescription to Southland Pharmacy in Taylor, Michigan from another pharmacy. Fill out our simple form and we'll handle the rest."
        />
      </Helmet>
